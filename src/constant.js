export const animations = [
  ...
  {
    title: "Bouncing Ball",
    description: "Create a ball that bounces vertically, simulating gravity and easing. ",
    path: "/bouncing-ball",
  },
  {
    title: "Simple Image Slider",
    description: "Animate images sliding from left to right, with ease effects.",
    path: "/image-slider",
  },
  {
    title: "Loading Spinner Animation",
    description: "Use GSAP to create a rotating circle for a loading animation.",
    path: "/loader-spinner",
  },
];